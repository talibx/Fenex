<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('inventories.index')" :active="request()->routeIs('inventories.index')">
                     ...
                     <x-nav-link :href="route('deductions.index')" :active="request()->routeIs('deductions.index')">
                        {{ __('Deductions') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('inventories.index')" :active="request()->routeIs('invnentory.index')">
                {{ __('Inventories') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('deductions.index')" :active="request()->routeIs('deductions.index')">
                {{ __('Deductions') }}
            </x-responsive-nav-link>
